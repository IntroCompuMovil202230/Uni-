...
public class ReservaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(view);
        String primerahora = getIntent().getStringExtra("primerahora");
        String segundahora = getIntent().getStringExtra("segundahora");

        binding.textDesdeHora.setText(primerahora);
        binding.textHastaHora.setText(segundahora);
