...
public class MapsActivity extends  FragmentActivity implements OnMapReadyCallback, RoutingListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.bottomNavegation.setOnItemSelectedListener(item -> {
            switch (item.getItemId()){
                case R.id.firstFragment:
                    buildAndShowNotification("Usuario Disponible", "El usuario:", "uiouiuio");
        ...
        Intent intent = new Intent(MapsActivity.this, NotificationIntentService.class);
        //startService(intent);
        NotificationIntentService.enqueueWork(MapsActivity.this, intent);
    ...
    //REVISA LA DISTANCIA QUE HAY ENTRE UN PUNTO Y OTRO Y DEVUELVE LA DISTANCIA EN KM
    private double distance(double myLat, double myLong, double otherLat, double otherLong){
        ...
        return 1000.0 * (Math.round(res * 100.0) / 100.0);
    }
                        ...
                        mapFragment.getMapAsync(new OnMapReadyCallback() {
                            ...
                            public void onMapReady(GoogleMap googleMap) {
                                ...
                                if(lastLocation == null){
                                    for(int i = 0; i < points.size(); i++){
                                        double distance = distance(location.getLatitude(),location.getLongitude(),points.get(i).latitude, points.get(i).longitude);
                                        if(distance < 30 ){
                                            noti = true;
                                            buildAndShowNotification("Pide un espacio", "Estas a " + String.valueOf(distance) + " metros de un espacio, aprovecha tu tiempo", "nn");
                                        }
                                    }
    ...
    private void buildAndShowNotification(String title, String message, String userKey){
        ...
        mBuilder.setSmallIcon(R.drawable.logo1bt);
